...
export class DownloadFormComponent implements OnInit, OnDestroy {
  ...
  platforms: Platform[] = [
    ...
    { name: 'Instagram',   icon: '📸',  status: 'ok',         hint: 'Anonymous extraction of public posts is working as of 2026-04-27. Login-walled / private posts still need instagram.com session cookies.' },
    { name: 'Reddit',      icon: '🤖',  status: 'ok',         hint: 'Anonymous extraction of public videos works. NSFW / quarantined subreddits still need reddit.com session cookies.' },
    { name: 'Rumble',      icon: '🤖',  status: 'ok',         hint: 'Anonymous extraction works on this host. (Some networks see Rumble IP-blocking; try a residential VPN if extraction starts failing.)' },
